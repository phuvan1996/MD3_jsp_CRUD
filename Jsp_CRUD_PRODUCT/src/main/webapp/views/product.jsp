...
<head>
    ...
    <link rel="shortcut icon" href="views/img/icons/icon-48x48.png"/>
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0"
                            ...
                            <div class="list-group">
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="views/img/avatars/avatar-5.jpg"
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="views/img/avatars/avatar-2.jpg"
                                                 class="avatar img-fluid rounded-circle"
                                                 alt="William Harris">
                                        </div>
                                        <div class="col-10 ps-2">
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="views/img/avatars/avatar-4.jpg"
                                                 class="avatar img-fluid rounded-circle"
                                                 alt="Christina Mason">
                                        </div>
                                        <div class="col-10 ps-2">
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="views/img/avatars/avatar-3.jpg"
                                                 class="avatar img-fluid rounded-circle"
                                                 alt="Sharon Lessman">
                                        </div>
                                        <div class="col-10 ps-2">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                            <img src="views/img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1"
                                 alt="Charles Hall"/>
                            <span class="text-dark">Pham Phu Van</span>
                        </a>
                    ...
                    <div class="card-header">
                        ...
                        <nav class="navbar navbar-expand-lg bg-light">
                            <div class="container-fluid">
                                <a class="navbar-brand" href="views/newproduct.jsp">
                                    <button type="button" class="btn btn-success">+ Add new Product</button>
                                </a>
                                <form class="d-flex" role="search" me>
                        ...
                        <table id="example1" class="table table-bordered table-striped text-center">
                            ...
                            <c:forEach items="${listproduct}" var="pro">
                                ...
                                <tr>
                                    ...
                                    <td>${pro.price}</td>
                                    <td>
                                        <fmt:formatDate value="${pro.dateCreated}"
                                                        pattern="dd-MM-yyyy"></fmt:formatDate>
                                    </td>
                                    <td>${pro.descriptions}</td>
                                    <td>${pro.productStatus?"Còn hàng":"Hết hàng"}</td>
                                    <td>
                                        <a href="<%=request.getContextPath()%>/ProducServelet?productId=${pro.productId}&&action=update">
                                            <button type="button" class="btn btn-warning">Edit</button>
                                        </a>
                                        <a href="<%=request.getContextPath()%>/ProducServelet?productId=${pro.productId}&&action=delete">
